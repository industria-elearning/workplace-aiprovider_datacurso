...
$string['error_webservice_not_configured'] = 'Diese Aktion kann nicht fortgesetzt werden, da der Datacurso-Webservice, der die KI mit Kontextdaten versorgt, nicht konfiguriert ist. Schließen Sie die automatische Einrichtung unter <a href="{$a->url}">Datacurso-Webservice-Einrichtung</a> ab und versuchen Sie es erneut. Oder wenden Sie sich für weitere Informationen an Ihren Administrator.';
$string['generate_chat_message'] = 'KI-Tutor-Nachricht generieren';
$string['hours'] = 'Stunden';
$string['licensekey_help'] = 'Geben Sie den Lizenzschlüssel Ihres Datacurso-KI-Anbieters ein.';
$string['licensekey_missing'] = 'Der Lizenzschlüssel ist nicht konfiguriert';
$string['link_provider_config'] = 'Anbieter-Konfiguration';
$string['link_provider_config_tenant'] = 'Anbieter-Konfiguration (Mandant)';
$string['minute'] = 'Minute';
$string['minutes'] = 'Minuten';
$string['months'] = 'Monate';
$string['notallowed'] = 'Sie sind nicht berechtigt, diese Aktion auszuführen. Bitte wenden Sie sich für weitere Informationen an Ihren Administrator.';
$string['privacy:metadata:aiprovider_datacurso_rlimit'] = 'Lokal gespeicherter Status der gleitenden Nutzungsrate pro Benutzer und Dienst.';
$string['privacy:metadata:aiprovider_datacurso_rlimit:lastsync'] = 'Zeitstempel der letzten Synchronisierung mit dem externen Verlauf.';
$string['privacy:metadata:aiprovider_datacurso_rlimit:serviceid'] = 'Dienst-Kennung (z. B. local_coursegen).';
...
$string['privacy:metadata:aiprovider_datacurso_rlimit:tokensused'] = 'Verbrauchte Kredite innerhalb des aktuellen Zeitfensters.';
$string['privacy:metadata:aiprovider_datacurso_rlimit:userid'] = 'Benutzer-ID, die sich auf das verfolgte Verbrauchsfenster bezieht.';
$string['privacy:metadata:aiprovider_datacurso_rlimit:windowstart'] = 'Zeitstempel des Fensterbegins zur Berechnung der Verbrauchslimits.';
$string['privacy:metadata:aiprovider_datacurso_userlimit'] = 'Lokal gespeicherte Datacurso-Token-Kontingente pro Benutzer.';
$string['privacy:metadata:aiprovider_datacurso_userlimit:countfrom'] = 'Zeitstempel, der angibt, wann das Kontingent mit der Erfassung der Nutzung begann.';
$string['privacy:metadata:aiprovider_datacurso_userlimit:lastsync'] = 'Zeitpunkt der letzten Synchronisierung der Nutzungsinformationen.';
$string['privacy:metadata:aiprovider_datacurso_userlimit:timecreated'] = 'Zeitpunkt, zu dem der Kontingentdatensatz erstellt wurde.';
$string['privacy:metadata:aiprovider_datacurso_userlimit:timemodified'] = 'Zeitpunkt, zu dem der Kontingentdatensatz zuletzt aktualisiert wurde.';
$string['privacy:metadata:aiprovider_datacurso_userlimit:tokenlimit'] = 'Maximale Anzahl an Token, die dem Benutzer gewährt wurden.';
$string['privacy:metadata:aiprovider_datacurso_userlimit:tokensused'] = 'Verbrauchte Token seit Beginn der Erfassung.';
$string['privacy:metadata:aiprovider_datacurso_userlimit:userid'] = 'Dem Kontingent zugeordnete Benutzer-ID.';
$string['ratelimit_enable'] = 'Ratenlimit aktivieren';
$string['ratelimit_enable_desc'] = 'Wenn aktiviert, wird das Kreditlimit pro Benutzer für dieses Plugin erzwungen.';
$string['ratelimit_limit'] = 'Kreditlimit pro Fenster';
$string['ratelimit_limit_desc'] = 'Maximale Anzahl an Krediten, die ein Benutzer innerhalb des gewählten Zeitfensters verbrauchen kann. 0 für unbegrenzt.';
$string['ratelimit_limit_help'] = 'Die maximale Anzahl von Anfragen, die pro Ratenlimit-Zeitfenster zulässig sind.';
$string['ratelimit_local_assign_ai_allowedusers_desc_help'] = 'Diese Einstellung definiert eine Liste spezifischer Benutzer, die vom globalen Ratenlimit für diesen KI-Dienst ausgenommen sind, sodass nur sie KI-basierte Bewertungen oder Feedback für Moodle-Aufgaben generieren können.';
$string['ratelimit_local_coursegen_activitycreators_desc_help'] = 'Wählen Sie die Benutzer aus, die Aktivitäten oder Ressourcen mit KI generieren können, wenn dieser Dienst aktiviert ist.';
$string['ratelimit_local_coursegen_coursecreators_desc_help'] = 'Wählen Sie die Benutzer aus, die vollständige Kurse mit KI erstellen können, wenn dieser Dienst aktiviert ist.';
...
$string['weeks'] = 'Wochen';
$string['ws_role_desc'] = 'Rolle für den Datacurso-Webservice';
$string['ws_role_name'] = 'Datacurso-Webservice';
$string['ws_service_name'] = 'Datacurso-Webservice';
