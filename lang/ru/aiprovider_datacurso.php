...
$string['year'] = 'год';
$string['days'] = 'Дни';
$string['error_ratelimit_exceeded'] = 'Допустимый лимит потребления превышен. Пожалуйста, попробуйте еще раз в {$a}.';
$string['error_webservice_not_configured'] = 'Это действие не может быть продолжено, так как веб-сервис Datacurso, который предоставляет контекстные данные для ИИ, не настроен. Завершите автоматическую настройку в <a href="{$a->url}">Настройка веб-сервиса Datacurso</a> и попробуйте снова. Или обратитесь к администратору для получения дополнительной информации.';
$string['generate_chat_message'] = 'Сгенерировать сообщение ИИ-тьютора';
$string['hours'] = 'Часы';
$string['licensekey_help'] = 'Введите ключ лицензии вашего провайдера ИИ Datacurso.';
$string['licensekey_missing'] = 'Ключ лицензии не настроен';
$string['link_provider_config'] = 'Конфигурация провайдера';
$string['link_provider_config_tenant'] = 'Конфигурация провайдера (арендатор)';
$string['minute'] = 'минута';
$string['minutes'] = 'Минуты';
$string['months'] = 'Месяцы';
$string['notallowed'] = 'Вам не разрешено выполнять это действие. Пожалуйста, свяжитесь с администратором для получения дополнительной информации.';
$string['privacy:metadata:aiprovider_datacurso_rlimit'] = 'Локально сохраненное состояние скользящего лимита использования на пользователя и на сервис.';
...
$string['privacy:metadata:aiprovider_datacurso_userlimit'] = 'Локально сохраненные квоты токенов Datacurso на пользователя.';
$string['privacy:metadata:aiprovider_datacurso_userlimit:countfrom'] = 'Метка времени, отмечающая начало отслеживания использования квоты.';
$string['privacy:metadata:aiprovider_datacurso_userlimit:lastsync'] = 'Последнее время синхронизации информации об использовании.';
$string['privacy:metadata:aiprovider_datacurso_userlimit:timecreated'] = 'Время создания записи о квоте.';
$string['privacy:metadata:aiprovider_datacurso_userlimit:timemodified'] = 'Время последнего обновления записи о квоте.';
...
$string['privacy:metadata:aiprovider_datacurso_userlimit:tokensused'] = 'Токены, израсходованные с начала отслеживания.';
$string['privacy:metadata:aiprovider_datacurso_userlimit:userid'] = 'ID пользователя, связанный с квотой.';
$string['ratelimit_limit_help'] = 'Максимальное количество запросов, разрешенных в одном окне лимита.';
$string['ratelimit_local_assign_ai_allowedusers_desc_help'] = 'Этот параметр определяет список конкретных пользователей, которые освобождены от глобального лимита для этого ИИ-сервиса, позволяя только им генерировать оценки или отзывы на основе ИИ для заданий Moodle.';
$string['ratelimit_local_coursegen_activitycreators_desc_help'] = 'Выберите пользователей, которые могут генерировать активности или ресурсы с помощью ИИ, когда этот сервис включен.';
$string['ratelimit_local_coursegen_coursecreators_desc_help'] = 'Выберите пользователей, которые могут создавать полные курсы с помощью ИИ, когда этот сервис включен.';
$string['ratelimit_window_unit'] = 'Единица измерения окна';
