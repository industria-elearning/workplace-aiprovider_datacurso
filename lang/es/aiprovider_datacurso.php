...
$string['link_provider_config_tenant'] = 'Configuración del proveedor (inquilino)';
$string['ratelimit_limit_help'] = 'El número máximo de solicitudes permitidas por ventana de límite de tasa.';
$string['ratelimit_local_assign_ai_allowedusers_desc_help'] = 'Esta configuración define una lista de usuarios específicos que están exentos del límite de tasa global para este servicio de IA, permitiendo que solo ellos generen calificaciones o retroalimentación basada en IA para las tareas de Moodle.';
$string['ratelimit_local_coursegen_activitycreators_desc_help'] = 'Seleccione los usuarios que pueden generar actividades o recursos con IA cuando este servicio está habilitado.';
$string['ratelimit_local_coursegen_coursecreators_desc_help'] = 'Seleccione los usuarios que pueden crear cursos completos con IA cuando este servicio está habilitado.';
$string['ratelimit_window_unit'] = 'Unidad de la ventana';
$string['ratelimit_window_value'] = 'Valor de la ventana';
